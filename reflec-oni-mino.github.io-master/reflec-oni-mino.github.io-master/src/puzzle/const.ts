...
export const new_year_2026: PuzzleData = [
    [
        ['#', '#', '#', '#', '#', '#', '#'],
        ['e', ' ', ' ', ' ', ' ', ' ', '#'],
        ['e', ' ', ' ', ' ', ' ', ' ', '#'],
    ...
    [
        {cell: [{x: -1, y: 0, type: '\\'},{x: 0, y: 0, type: '/'},{x: 1, y: 0, type: '\\'}], vertex: [-50, 0, 100, 0, 100, 50, -50, 50], pos: undefined},
        {cell: [{x: 0, y: 1, type: '￭'},{x: -1, y: 0, type: '￭'},{x: 0, y: 0, type: '/'}], vertex: [-50, 0, 50, 0, 50, 100, 0, 100, 0, 50, -50, 50], pos: undefined},
        {cell: [{x: 0, y: -1, type: '￭'},{x: 0, y: 0, type: '\\'},{x: 0, y: 1, type: '/'}], vertex: [0, -50, 50, -50, 50, 100, 0, 100], pos: undefined},
        {cell: [{x: -1, y: 0, type: '\\'},{x: 0, y: 0, type: '/'},{x: 1, y: 0, type: '/'}], vertex: [-50, 0, 100, 0, 100, 50, -50, 50], pos: undefined},
        {cell: [{x: 0, y: -1, type: '￭'},{x: 0, y: 0, type: '￭'},{x: 0, y: 1, type: '/'}], vertex: [0, -50, 50, -50, 50, 100, 0, 100], pos: undefined},
        {cell: [{x: 1, y: 0, type: '\\'},{x: 0, y: -1, type: '￭'},{x: 0, y: 0, type: '￭'}], vertex: [0, 50, 0, -50, 50, -50, 50, 0, 100, 0, 100, 50], pos: undefined},
        {cell: [{x: 0, y: 0, type: '￭'},{x: 0, y: -1, type: '/'},{x: -1, y: 0, type: '\\'}], vertex: [0, 0, 0, -50, 50, -50, 50, 50, -50, 50, -50, 0], pos: undefined}
    ],
    [
        {   start: {x: 3, y: 6},
            end: {x: 0, y: 1},
            ...
            vertex: [125, 275, 125, 225, 125, 175, 125, 125, 125, 75, 125, 25, 125, -25]
        },
        {   start: {x: 6, y: 3},
            end: {x: 0, y: 2},
            board: [
            ...
            vertex: [275, 125, 225, 125, 175, 125, 125, 125, 75, 125, 25, 125, -25, 125]
        }
    ]
]