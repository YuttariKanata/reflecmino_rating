...
export function generate(mode: Mode, seed: number): PuzzleData {
    ...
    const draw_random_laser = (board: string[][], laser: { mirror: number, x: number, y: number, move: Move }) => {
        ...
        const new_data = while_f(initial, s => {
            ...
            for (let i = 0; i < s[0].length; i++) {
                //console.table(s[0][i][0]);
                //console.log(s[0][i][1]," ",s[0][i][2]," ",s[0][i][3]," ",s[0][i][4]);
            }
            //console.log(s[1]);
            //console.dir(s, {depth:null, color:true})
            // if (s[1] <= 90) {
    ...
    const draw_two_laser = (): [board: string[][], start: { x: number, y: number }[], end: { x: number, y: number }[]] => {
        ...
        //console.table(draw_1_data[0]);
        console.log([...draw_1_data[0]].join("\n").replace(/,/g, " "));
        console.log(draw_1_data[1]," ",draw_1_data[2]," ",draw_1_data[3]," ",draw_1_data[4]);
        ...
        //console.table(draw_2_data[0]);
        console.log([...draw_2_data[0]].join("\n").replace(/,/g, " "));
        console.log(draw_2_data[1]," ",draw_2_data[2]," ",draw_2_data[3]," ",draw_2_data[4]);
    ...
    const place_random_mino = (data: PlaceMino): PlaceMino => {
        ...
        if (placeable_mino.length > 0) {
            ...
            console.log(random_mino_id)
            console.log(place_mino.protrusion)
            const place_cell = [
            ...
            console.log(x," ",y," ",place_cell[0]," ",place_cell[1])
    ...
    const puzzle_data = while_f(initial, s => {
        ...
        for (let i = 0; i < minoCount; i++) {
            console.log("\n== 7 ==")
            console.log(placed_minos_board[1])
            console.log(rnd)
        ...
        return [[...placed_minos_board[0]].flat().includes("/") || [...placed_minos_board[0]].flat().includes("\\") || placed_minos_board[2].length !== minoCount, return_data];
...
let rn = new random(20260620)
console.log(rn.next_int(4,4) > 0)
console.dir(generate("HellMode", 20260620), {depth:null, color:true})
